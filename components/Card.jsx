...
function Card(props) {
  ...
  return (
    <div className="h-fit w-fit " data-aos="flip-up">
      <motion.div
        animate={{ height: !Expanding ? "auto" : 580 }}
        type={spring}
        Layout
        duration="2000"
        className="b0g-white h-fit  w-[350px]  rounded-lg  shadow-2xl hover:shadow-slate-700  "
        style={{
        ...
        <div className="flex flex-col h-full  ">
          ...
          <div className="flex flex-col h-full  m-1  ">
            <div className="flex items-center ">
              <a
                href=""
                className="flex   font-bold text-[25px] mb-2 ml-2  w-[500px]"
              >
                {props.title}
              </a>

              <div className="mr-2 flex justify-end items-center  w-full">
                <a
              ...
              <Popup
                trigger={
                  <button className="w-20 h-10">
                    {" "}
                    <FaShareAltSquare className="h-6 w-6" />{" "}
                  </button>
                }
              ...
              >
                ...
                >
                  <WhatsappShareButton
                    url={`https://firebasestorage.googleapis.com/v0/b/iedccecbackend.appspot.com/o/${props.image}`}
                  >
